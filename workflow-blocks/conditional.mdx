...
description: "Add decision logic to your workflow with If/Conditional blocks"
icon: "code-branch"
---
...
Let's say you want to send a notification only when certain criteria are met:

Condition: "Is the lead's score above 80?"

- If True: Send a high-priority notification to sales
- If False: Skip the notification
