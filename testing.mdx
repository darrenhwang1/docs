...
When testing your workflow, you'll notice a "Terminal" button that appears during execution. This powerful debugging tool gives you an inside look at what's happening behind the scenes:

1. Click the "Terminal" button to open the debug panel
2. View detailed information about each workflow block's execution
3. See exactly what actions your agent took and why

The terminal provides valuable insights including:

- A clear explanation of what the agent did at each step
- The parsed HTML from web interactions
