...
1. **Describe Your Intent**: Tell the AI Assistant what you want your agent to do in plain English. You can now include multiple actions in a single instruction
